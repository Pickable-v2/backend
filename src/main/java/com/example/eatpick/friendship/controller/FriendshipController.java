...
public class FriendshipController {
    ...
    public ResponseEntity<Page<SearchResponse>> search(@RequestParam(name = "loginId") String loginId, @PageableDefault(sort = "id", direction = Sort.Direction.DESC, size = 10) Pageable pageable) {
